...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "santon-starter"
  ...
  # using a specific IP.
  config.vm.network :private_network, ip: "10.33.33.50"
  # config.vm.network :hostonly, "10.33.33.50"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/genforen"
  #   chef.validation_client_name = "genforen-validator"
  #   chef.validation_key_path = ".chef/genforen-validator.pem"
  # end
end
